...
export default function WhoAmI() {
  ...
  return (
    <>
      <a
        href="#whoami-title"
        className="absolute top-0 left-0 bg-primary text-white p-2 -translate-y-full focus:translate-y-0 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-transform z-50"
      >
        Aller au contenu
      </a>
