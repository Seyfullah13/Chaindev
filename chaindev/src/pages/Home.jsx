  ...
  return (
    ...
    >
      <header className="w-full max-w-2xl text-center mt-6">
        <h1 className="text-white text-3xl md:text-5xl font-bold mb-4" tabIndex={0}>
          Chaindev
        </h1>
        <h2 className="text-white text-lg md:text-2xl font-semibold mb-2" tabIndex={0}>
      ...
      <section className="w-full max-w-2xl bg-black/60 rounded-lg p-4 mt-4 mb-4">
        <p className="text-white text-base md:text-lg mb-2" tabIndex={0}>
          Solutions web sur mesure incluant développement, infrastructure sécurisée
          et assistance technique permanente.
        </p>
      </section>
      ...
      <section className="w-full max-w-2xl bg-black/60 rounded-lg p-4 mb-4">
        ...
        <p className="text-white text-base md:text-lg" tabIndex={0}>
          Développeur Fullstack Freelance et multilingue, je crée des sites web
          sur mesure prêts pour l'international. Un seul prestataire pour le
          développement et la traduction. Organisation claire, livrables fiables,
